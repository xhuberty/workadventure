...
export class Zone {
    ...
    constructor(private positionDispatcher: PositionDispatcher, private socketListener: ZoneEventListener, public readonly x: number, public readonly y: number) {
    }
    ...
    public async init(): Promise<void> {
        ...
        this.backConnection.on('error', (e) => {
            if (!this.isClosing) {
                ...
                // TODO: display error and close connection and trigger close of all sockets attached!
                // TODO: we need to kill any reference to this object!
            }
        });
